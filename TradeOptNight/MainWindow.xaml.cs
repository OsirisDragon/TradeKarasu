...
namespace TradeOptNight
{
    ...
    public partial class MainWindow : DevExpress.Xpf.Core.ThemedWindow
    {
        ...
        public MainWindow()
        {
            ...
            AppSettings.SysShortAliasID = "O";
            AppSettings.SysDayOrNightText = "(夜盤)";
            AppSettings.SystemType = SystemType.OptNight;
            AppSettings.LocalReportDirectoryWithoutDate = "C:\\option_night";
            ...
            if (args.Length > 1)
            {
                ...
                this.Title = "選擇權夜盤" + "-" + directOpenProgramID + "-" + directOpenProgramName;
                //this.Topmost = true;
