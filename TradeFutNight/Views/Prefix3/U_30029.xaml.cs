...
namespace TradeFutNight.Views.Prefix3
{
    ...
    public partial class U_30029 : UserControlParent, IViewSword
    {
        ...
        public async Task Save()
        {
            ...
            {
                var trackableData = _vm.MainGridData.CastToIChangeTrackableCollection();
                var domainData = CustomMapper<TPPVOL>(trackableData.ChangedItems);
        ...
        private IList<T> CustomMapper<T>(IEnumerable<UIModel_30029> items) where T : TPPVOL
        {
        ...
        private XtraReport CreateReport<T>(IList<T> data, OperationType operationType)
        {
            ...
            rptSetting.ContentColumnsWidthScaleFactor = 0.84f;
            rptSetting.HeaderColumnsWidthScaleFactor = 0.84f;
