...
namespace TradeFutNight.Views.Prefix3
{
    public class U_30026_ViewModel : ViewModelParent<UIModel_30026>
    {
        ...
        public void Open()
        {
            ...
            MainGridData = new ObservableCollection<UIModel_30026>().ToList().AsTrackable();

            using (var das = Factory.CreateDalSession())
            {
                var dTPPINTD = new D_TPPINTD(das);
                MainGridData = MapperInstance.Map<IList<UIModel_30026>>(dTPPINTD.ListAll()).AsTrackable();
            }
