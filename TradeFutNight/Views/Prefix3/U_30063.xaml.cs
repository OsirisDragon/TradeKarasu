...
namespace TradeFutNight.Views.Prefix3
{
    ...
    public partial class U_30063 : UserControlParent, IViewSword
    {
        ...
        private void MexReceivedDataProcess(List<MexReceivedData_30063> items)
        {
            ...
            //                    dGdex.GetTopOne(1, Ocf.OCF_DATE);
            //                }

            //                ConnectionInfo connectionInfo = SettingDragons.Instance.GetConnectionInfo(SettingDragons.Instance.Setting.Database.Tfxms);

            //                DataTable dtGDEX = Service.Do().Service30063.ListGDEX(connectionInfo, 1, GlobalInfo.OCF_DATE);

            //                if (dtGDEX.Rows.Count != 0)
            //                {
            //                    GDEX_EX_RATE = dtGDEX.Rows[0]["GDEX_EX_RATE"].AsDouble();
            //                }

            //                row["EXRT_EXCHANGE_RATE"] = Math.Round(GDEX_EX_RATE, 6);
            //            }
