...
{
    public partial class U_50308_Report : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public U_50308_Report()
        {
            InitializeComponent();
        }

        private void U_50308_Report_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (RowCount == 0)
            {
