...
{
    public partial class U_50301_Report : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public U_50301_Report()
        {
            InitializeComponent();
        }

        private void U_50301_Report_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (RowCount == 0)
            {
