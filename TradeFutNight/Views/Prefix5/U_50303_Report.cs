...
{
    public partial class U_50303_Report : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public U_50303_Report()
        {
            InitializeComponent();
        }

        private void U_50303_Report_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (RowCount == 0)
            {
